...
public class BotOwnersDAO {
    ...
    @FromTextFile(fileName = "sql/bot_owners/insert_value_query.sql")
    private String insertValueQuery = null;

    BotOwnersDAO(@NotNull Connection connection) {
        this.connection = connection;
        ResourcesLoader.initFileResources(this, BotOwnersDAO.class);
    }
